...
module "ecs" {
  ...
  # BUG FIX: ECS tasks run securely in private subnets
  private_subnet_ids = module.vpc.private_subnet_ids

  # REFACTOR: Bind to the central unified application security group
  ...
  # Backward compatible parameter (used for standard tasks ingress)
